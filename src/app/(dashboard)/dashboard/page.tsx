                ...
                <div className="card p-6">
                  ...
                  {data?.byPaymentMethod?.length > 0 ? (
                    <ResponsiveContainer width="100%" height={220}>
                      <PieChart>
                        <Pie data={data.byPaymentMethod} dataKey="revenue" nameKey="method" cx="50%" cy="50%" outerRadius={80} label={({ method, percent }) => `${method} ${(percent*100).toFixed(0)}%`} labelLine={false}>
